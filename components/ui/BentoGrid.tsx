...
export const BentoGridItem = ({
  ...
  spareImg?: string;
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('mahanthvamsis1@gmail.com');
        setCopied(true);
            ...
            <div className={`absolute right-0 -bottom-5 ${id === 5 && 'w-full opacity-80'}`}>
                {spareImg && (
                    <img
                        src={spareImg}
                        alt={spareImg}
                        className={"object-cover, obeject-center w-full h-full"}
                    />
                )}
            </div>
            {id === 6 && (
            ...
            {id === 3 && (
                <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
                    <div className="flex flex-col gap-3 lg:gap-8">
                        {["JS", "next.js", "react.js","Java"].map((item) => (
